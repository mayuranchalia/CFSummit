component rest="true" restpath="products"   {
	...
	function addProduct(required string productName restargsource="form" restargname="productName",
		...
		httpmethod="POST" produces="application/json" returntype="CFSummit.Product.model.product"  description="Add a new product"   {
	...
	function getProducts() access="remote" produces="application/json" httpmethod="GET" 
					returntype="CFSummit.Product.model.product[]" description="Get list of products"{
			productPersistence = createObject("component", "CFSummit.Product.persistence.productpersistence" );
	...
	function getProductById(required numeric productId restargsource="Path" restargname="productId") access="remote" restpath="{productId}"  
			produces="application/json" returntype="CFSummit.Product.model.product"  description="Retrieve product details by product id"  {
	...
	function searchProducts(required numeric searchId restargsource="query " restargname="searchId")  access="remote" httpmethod="GET" produces="application/json" restpath="search" 
	 				returntype="CFSummit.Product.model.product[]" description="Search list of products by brand id" {
		productPersistence = createObject("component", "CFSummit.Product.persistence.productpersistence" );
	...
	function getBrands() access="remote" httpmethod="GET" restpath="brand" returntype="CFSummit.Product.model.brand[]" 
	...
	function getCategories() access="remote" httpmethod="GET" restpath="category" returntype="CFSummit.Product.model.category[]" 
	 ...
	 function addBrand(required string brandName restargsource="Form" restargname="brandName",
	 	...
	 	consumes="application/x-www-form-urlencoded"  restpath="brand" returntype="CFSummit.Product.model.brand" description="Add a new brand"{
	     	brandPersistence = createObject("component", "CFSummit.Product.persistence.brandpersistence" );
	  ...
	  function addCategory(required string categoryName restargname="categoryName" restargsource="Form",
	  	required string categoryDescription restargname="categoryDescription" restargsource="Form")access="remote" httpmethod="POST" restpath="category" returntype="CFSummit.Product.model.category" 
